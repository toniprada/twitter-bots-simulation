...
public class StudentsState extends SimState {
    ...
    public double TEMPERING_INITIAL_RANDOM_MULTIPLIER = 0.0;
    ...
    {
        Bag students = network.getAllNodes();
    ...
    public StudentsState(long seed) {
        super(seed);
    }
...
j
        ...
        // clear the network
        network.clear();
        // add some students to the yard at random positions
        for(int i = 0;i<numStudents;i++) {
            Student student = new Student();
            yard.setObjectLocation(student, new Double2D(yard.getWidth()*random.nextDouble(),
                    yard.getHeight()*random.nextDouble()));
            network.addNode(student);
        ...
        for(int i = 0; i < students.size(); i++)
        {
            ...
            network.addEdge(student, studentB, 1.0);
        }*/
    }
    ...
    public static void main(String[] args) {
        doLoop(StudentsState.class, args);
        System.exit(0);
    }
}